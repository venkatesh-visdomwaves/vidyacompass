...
const parentNavLinks = [
    { name: 'Dashboard', href: '/parents/dashboard' },
    { name: 'Finance', href: '/parents/financial-support' },
    { name: 'Safety', href: '/parents/risk-safety' },
    { name: 'Expert help', href: '/parents/expert-guidance' }
];

const ParentSubNavbar = () => {
    ...
    const getBreadcrumb = () => {
        ...
        if (path === '/parents') return 'Overview';
        const link = parentNavLinks.find(l => l.href === path);
            ...
            <div className={`bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm ${isSticky ? 'py-1' : 'py-2'}`}>
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="flex items-center gap-2 text-[8px] font-bold uppercase tracking-widest text-gray-400 mb-1">
                        ...
                        <span>/</span>
                        <Link to="/parents" className="hover:text-[#1e3a8a]">Parents</Link>
                    ...
                    <div className="flex items-center justify-between h-10 gap-2">
                        ...
                        {/* Brand Accent */}
                        <div className="hidden lg:flex items-center gap-1 opacity-40 grayscale group hover:grayscale-0 hover:opacity-100 transition-all cursor-default text-xs font-bold text-[#1e3a8a] uppercase tracking-tighter">
                            Security First
                        </div>
                    </div>
                </div>
...
export default ParentSubNavbar;
